...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\LaravelProject\ikp-fillament\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\LaravelProject\\ikp-fillament\\public\\storage','logging.default','logging.deprecations.channel',
...
'debugbar.queries.explain','filament.exports.download','filament.imports.failed-rows.download','filament.app.auth.login','filament.app.auth.logout',
'filament.app.pages.dashboard','filament.app.resources.insidens.index','filament.app.resources.insidens.create','filament.app.resources.insidens.edit','filament.app.resources.insidens.update-grading',
'filament.app.resources.jabatans.index','filament.app.resources.jabatans.create','filament.app.resources.jabatans.edit','filament.app.resources.jenis-insidens.index','filament.app.resources.jenis-insidens.create',
'filament.app.resources.jenis-insidens.edit','filament.app.resources.pasiens.index','filament.app.resources.pasiens.create','filament.app.resources.pasiens.view','filament.app.resources.pasiens.edit',
'filament.app.resources.pegawais.index','filament.app.resources.penanggung-biayas.index','filament.app.resources.units.index','filament.app.resources.shield.roles.index','filament.app.resources.shield.roles.create',
'filament.app.resources.shield.roles.view','filament.app.resources.shield.roles.edit','livewire.update',
'livewire.upload-file','livewire.preview-file',
'storage.local',);
        registerArgumentsSet('views', 
'components.icons.alert-triangle','components.icons.arrow-back','components.icons.arrow-back-up','components.icons.bed','components.icons.caret-up-down',
'components.icons.category','components.icons.category-2','components.icons.category-filled','components.icons.category-minus','components.icons.category-plus',
'components.icons.check','components.icons.chevron-down','components.icons.chevron-left','components.icons.chevron-right','components.icons.circle-check',
'components.icons.circle-plus','components.icons.circle-x','components.icons.dashboard','components.icons.database','components.icons.database-star',
'components.icons.database.plus','components.icons.dots-vertical','components.icons.edit','components.icons.edit-circle','components.icons.file-excel',
'components.icons.gender-female','components.icons.gender-male','components.icons.git-branch','components.icons.hash','components.icons.health-recognition',
'components.icons.heart','components.icons.heart-handshake','components.icons.label','components.icons.label-filled','components.icons.login',
'components.icons.login-2','components.icons.logout','components.icons.logout-2','components.icons.moneybag','components.icons.pig-money',
'components.icons.print','components.icons.refresh','components.icons.report','components.icons.report-search','components.icons.restore',
'components.icons.ribbon-health','components.icons.rosette-discount-check','components.icons.run','components.icons.search','components.icons.settings',
'components.icons.shield','components.icons.sign-right','components.icons.trash','components.icons.user','components.icons.user-edit',
'components.icons.user-minus','components.icons.user-plus','components.icons.user-search','components.icons.user-shield','components.icons.user-shild',
'components.icons.users','components.icons.walk','components.kbd','components.layouts.app','debug',
'filament.inputs.grading-radio','filament.pages.update-grading','filament.tables.columns.name-with-gender','livewire.auto-grading','livewire.auto-grading-view',
'livewire.auto-grading2','welcome','filament-actions::badge-action','filament-actions::badge-group','filament-actions::button-action',
...
'filament-actions::link-group','filament-actions::select-action','filament-autograph::signature-pad','filament-forms::component-container','filament-forms::components.actions',
...
'auth.0','pagination.0','passwords.0','validation.0','filament-shield.0',
...
'filament-shield::filament-shield.resource_permission_prefixes_labels.replicate','filament-shield::filament-shield.resource_permission_prefixes_labels.reorder','filament-shield::filament-shield.resource_permission_prefixes_labels.restore_any','filament-shield::filament-shield.resource_permission_prefixes_labels.change_role','filament-shield::filament-shield.resource_permission_prefixes_labels.change_password',
...
'filament-forms::components.rich_editor.toolbar_buttons.redo','filament-forms::components.rich_editor.toolbar_buttons.strike','filament-forms::components.rich_editor.toolbar_buttons.underline','filament-forms::components.rich_editor.toolbar_buttons.undo','filament-forms::components.select.actions.create_option.modal.heading',
'filament-forms::components.select.actions.create_option.modal.actions.create.label','filament-forms::components.select.actions.create_option.modal.actions.create_another.label','filament-forms::components.select.actions.edit_option.modal.heading','filament-forms::components.select.actions.edit_option.modal.actions.save.label','filament-forms::components.select.boolean.true',
...
'filament-forms::validation.distinct.only_one_must_be_selected','filament-infolists::components.0','filament-notifications::database.modal.heading','filament-notifications::database.modal.actions.clear.label','filament-notifications::database.modal.actions.mark_all_as_read.label',
...
'filament-tables::table.sorting.fields.column.label','filament-tables::table.sorting.fields.direction.label','filament-tables::table.sorting.fields.direction.options.asc','filament-tables::table.sorting.fields.direction.options.desc','filament-autograph::filament-autograph.0',);
