...
class UserPolicy
{
     ...
     * @return bool
     */
    public function change_role(User $user): bool
    {
        return $user->can('change_role_pegawai');
    }
     ...
     * @return bool
     */
    public function change_password(User $user): bool
    {
        return $user->can('change_password_pegawai');
    }
}
