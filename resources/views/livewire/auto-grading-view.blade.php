@php
    ...
    if ($getState()['jenis_insiden_id'] && $getState()['unit_id'] && $getState()['dampak_insiden']) {
        $probabilitas = AutoGradingHelper::getProbabilityLevel($getState()['jenis_insiden_id'], $getState()['unit_id']);
        $impact = AutoGradingHelper::getImpactLevel($getState()['dampak_insiden']);
