...
<div>
    <iframe src="{{ route('rca.fishbone.render', ['key' => $key, 'id' => $id]) }}" frameborder="0" scrolling="no" class="w-full h-full" style="min-height: 450px; overflow: hidden;"></iframe>

    {{-- <div id="{{ $id }}" style="height: 450px; width: 100%; border: 1px solid black;  background: #fff;"></div> --}}
